  ...
  return (
    <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-between gap-10">
      <div className="flex-1 text-left">
        <h1 className="text-5xl font-bold mb-4 text-orange-800 drop-shadow-sm">
        ...
        <motion.h2
          ...
          className="text-2xl md:text-3xl font-semibold bg-gradient-to-r from-orange-600 via-amber-500 to-yellow-400 
          bg-clip-text text-transparent italic tracking-wide mb-6 drop-shadow-md"
        >
          A Home of Our Local Handicrafts
        </motion.h2>
